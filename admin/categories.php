<?php
 ...
 $categories = $category->getCategoriesWithParentName();
 ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <td><?php echo $category['parent_name'] ? $category['parent_name'] : 'As Parent' ?></td>
                                                            ...
                                                            <td><a href="category_update.php?id=<?php echo $category['id']; ?>" class="badge badge-success p-2">Update</a>

                                                        <form class="form-horizontal" role="form" action="coltroller/CatecoryController.php" method="post">
                                                         <input type="hidden" name="action" value="delete_category" required readonly="">
                                            <input type="hidden" name="id" value="<?php echo $category['id']  ?>" required readonly="">
