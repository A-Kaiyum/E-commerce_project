                    ...
                    <div class="container">
                        ...
                        <?php foreach($getUsers as $key=>$user){  ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="user_update.php?id=<?php echo $user['id']; ?>" class="badge badge-success p-2">Update</a>
                                            ...
                                            <input type="hidden" name="id" value="<?php echo $user['id']  ?>" required readonly="">
