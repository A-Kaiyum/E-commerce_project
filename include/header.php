	...
	<p><i class="fa fa-phone" aria-hidden="true"></i>	   Call Us: <?=$getSetting['support_phone']?></p>
	</div>
	</div>
	...
	<li class="wishlist hidden-xs"><a href="#" id="wishlist-total" class="top-link-wishlist" title="Welcome Customer!"><span>Welcome <?=$_SESSION['customer_name']?></span></a></li>

	<li class="signin"><a href="my-account.php" class="top-link-checkout" title="My Account"><span>My Account</span></a></li>
...
<?php }  ?>
	...
	<span class="number-shopping-cart"><?=$item?></span>
	<span class="title">My Cart</span>
	<p class="text-shopping-cart cart-total-full"> TK.<?=$sum?> </p>
	</div>
	</a>
 ...
 <?php if(!empty($_SESSION['cart'])){ ?>
	...
	<a href="product.html"> <img src="admin/uploads/product/<?=$cart['image']?>" style="width:70px" alt="Filet Mign" title="Filet Mign" class="preview"> </a>
	</td>
	<td class="text-left"> <a class="cart_product_name" href="product.html"><?=$cart['name']?></a> </td>
	<td class="text-center"> x<?=$cart['quantity']?> </td>
	<td class="text-center"> TK. <?=$cart['quantity']*$cart['price']?> </td>
	<td class="text-right">
	<a href="product.php" class="fa fa-edit"></a>
	</td>
	<td class="text-right">
	<a href="javascript:void(0)" onclick="cart.remove('<?=$key?>');" class="fa fa-times fa-delete"></a>
	</td>
	</tr>
   <?php  } ?>
	
   <?php } else{ echo "<tr><td>Shopping cart is empty!!</td></tr>"; } ?>
    </tbody>
	</table>
	</li>
	<li>
	...
	<td class="text-right" id="total-cart-amount">TK. <?=$sum?></td>
	</tr>
	</tbody>
	</table>
